...
export class FileUtils {
   ...
   */
  static validateBpmnFile(xmlContent: string): boolean {
    try {
...
export class PathUtils {
   ...
   */
  static getAlternativePath(): string[] {
    return [
      "StartEvent_1",
      "SequenceFlow_1",
      "Task_1",
   ...
   */
  static getElementsByType(elements: any[], type: string): string[] {
    return elements
      .filter((el) =>
        el.bpmnSemantic.kind.toLowerCase().includes(type.toLowerCase())
      )
