...
class BpmnVisualizerApp {
  ...
  loadAvailableFiles() {
    ...
    console.log(
      "✅ Arquivos carregados. Total de opções:",
      this.fileSelector.options.length
    );
  }
  /**
