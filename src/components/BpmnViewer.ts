// Importação da biblioteca real bpmn-visualization-js
import { BpmnVisualization } from "../lib/bpmn-visualization-real.js";
...
export class BpmnViewer {
   ...
   */
  private smartFitDiagram(bpmnXml: string): void {
...
export class PathDrawer {
   ...
   */
  private highlightElement(elementId: string, style: PathStyle): void {
    try {
